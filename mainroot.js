    ...
    if (filesByChar[char].length > 0) {
      filesByChar[char].forEach((file) => {
        ...
        btn.onclick = () => {
          ...
          fetch(
            `https://raw.githubusercontent.com/Hambo198213/UNB_23218948729378423789421378942137890234187914239784213786421367421376824137684231_API/main/UNB-files/${encoded}`,
          )
